...
function main() {
  ...
  while (isGameRunning) {
    ...
    */
    ...
    if(gameMode == '1'){
      coordinates = coordinate.getPlayerMove(gameBoard, currentPlayer);
      gameBoard[coordinates[0]][coordinates[1]] = currentPlayer;
  }
  else if(gameMode == '2'){
      coordinates = coordinate.getRandomAiCoordinates(gameBoard , currentPlayer);
      gameBoard[coordinates[0]][coordinates[1]]=currentPlayer;
      ...
      if (currentPlayer == "X"){
        ...
        coordinates = coordinate.getUnbeatableAiCoordinates(gameBoard , currentPlayer);
          gameBoard[coordinates[0]][coordinates[1]]=currentPlayer;
